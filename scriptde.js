...
const words1 = ["die", "das", "der", "akt", "amt", "ate", "auf", "bär", "bau", "bei", "bin", "bis", "bus", "den", "dom", "ein", "eis", "elf", "eng", "fan", "fax", "fit", "fuß", "gar", "gut", "hai", "hin", "hof",
    "hut", "ice", "ich", "ind", "inn", "ins", "ist", "klo", "kuh", "lkw", "maß", "men", "mit", "mon", "mut", "nah", "nen", "ner", "nie", "not", "nst", "ode", "ohr", "oma", "opa", "per", "pro", "rad", "rat", "rot",
    "ruf", "sag", "see", "sie", "ski", "stu", "süß", "tal", "tee", "ton", "tor", "ums", "uni", "von", "vor", "wie", "wir", "wut", "zeh", "zum", "zur",
];
...
const words2 = ["affe", "akku", "asyl", "audi", "aufs", "aula", "bach", "ball", "bank", "bart", "baum", "bein",
    ...
    "club", "cola", "dach", "damm", "deal", "dick", "doof", "dorf", "dort", "dose", "drei", "dual", "dünn",    "echt", "ecke", "eile", "eine", "ende", "ente", "esel", "etui", "euch", "euro", "ewig", "fach", "fade",    "fair", "farm", "faul", "fein", "feld", "fels", "fern", "fete", "fett", "flug", "flur", "föhn", "form",    "förn", "foto", "gabe", "gang", "ganz", "gast", "geil", "gelb", "glas", "gmbh", "golf", "gott", "grab",
    "grad", "gras", "grau", "grob", "grün", "gruß", "gute", "haar", "hahn", "halb", "hals", "harz", "hase",    "heft", "heiß", "hell", "hemd", "herd", "herr", "hier", "holz", "hose", "huhn", "hunt", "igel", "irre",    "jazz", "jude", "juli", "juni", "jura", "jury", "kalb", "kamm", "kann", "käse", "kauf", "kein", "kinn",    "kino", "klub", "klug", "knie", "koch", "köln", "komö", "kork", "krug", "kuba", "kühl", "kurs", "kuss",
    "lage", "lahm", "lamm", "lärm", "laus", "leer", "lieb", "lied", "lila", "lira", "loch", "lohn", "löwe",    "lüge", "lupe", "lust", "mars", "märz", "maus", "meer", "mehl", "mode", "mond", "most", "mühe", "müll",    "nach", "narr", "nass", "nerv", "netz", "neun", "noch", "note", "nuss", "ober", "obst", "oper", "ossi",    "park", "pech", "peru", "pfad", "post", "puls", "punk", "qual", "rand", "rang", "rast", "real", "reif",
    "rein", "reis", "ring", "rock", "rosa", "rose", "rote", "rübe", "ruhm", "rund", "saal", "säen", "saft",    "säge", "salz", "sand", "satt", "satz", "sehr", "seil", "sein", "sekt", "senf", "sich", "sieg", "sitz",    "slip", "smal", "sofa", "soße", "spaß", "spur", "stab", "stau", "stil", "tanz", "taub", "taxi", "teig",    "test", "text", "tief", "tier", "tipp", "topf", "tuch", "turm", "tüte", "üben", "ufer", "umso", "vase",
    "vati", "viel", "wald", "wand", "wann", "ware", "warm", "wein", "werk", "wert", "wien", "wild", "wind",    "witz", "wolf", "wurm", "zahl", "zahn", "zaun", "zehn", "zelt", "zimt", "zoll", "zone", "zorn", "zwar",    "mist", "toll", "food", "vorn",
];
let selectedWord2 = words2[Math.floor(Math.random() * words2.length)];

const words3 = ["acker", "adler", "agent", "aktie", "alarm", "allee", "ally", "allzu", "alpen", "ampel",    "anbau", "angst", "answo", "änung", "anzug", "apfel", "april", "ärger", "ärmel", "armut", "artig",    "asche", "außen", "außer", "autor", "azubi", "baden", "basis", "bauch", "bauen", "bauer", "beleg",    "benen", "beruf", "beste", "beute", "bezug", "bibel", "biene", "bitte", "blatt", "blick", "blind",
    "blitz", "blond", "blume", "bluse", "bohne", "börse", "brand", "braun", "braut", "breit", "brett",    "brust", "buche", "bühne", "bulle", "busch", "chaos", "chile", "china", "comic", "couch", "dabei",    "dampf", "datum", "dauer", "davor", "decke", "dicht", "disco", "döner", "draht", "drama", "droge",    "dumpf", "durst", "duzen", "eigen", "eilen", "eimer", "einan", "einen", "eines", "einst", "eisen",    "eisig", "eklig", "enden", "enkel", "enorm", "entwe", "erste", "essen", "essig", "etwas", "exakt",
    "fabel", "faden", "fahne", "fähre", "fahrt", "farbe", "fegen", "feige", "figur", "firma", "fisch",    "flach", "fleck", "flöte", "fluss", "folge", "frech", "freie", "fremd", "frohe", "fromm",    "frost", "fuchs", "fügen", "gabel", "geige", "gemäß", "gerät", "getue", "glatt", "gleis", "gramm",
    "griff", "größe", "gummi", "guten", "güter", "gütig", "hafen", "hagel", "haken", "handy", "harfe",    "härte", "hauen", "hecke", "heißt", "heute", "hitze", "hobby", "honig", "hörer", "hügel", "human",    "humor", "hupen", "hütte", "hymne", "ideal", "ikone", "immer", "innen", "insel", "irren", "jacke",    "jacob", "jäger", "japan", "jeans", "jedes", "jener", "jüdin", "kabel", "käfig", "kalen", "kamel",
    "kamin", "kanal", "kanar", "kanne", "karte", "kasse", "kater", "katze", "kauen", "kehle", "keine",    "kerze", "kiosk", "klage", "kleid", "klima", "knast", "knopf", "kohle", "kommt", "konto", "korea",    "krach", "krebs", "kreis", "kreuz", "krimi", "krise", "krone", "krumm", "küche", "kugel", "kunde",    "kunst", "kurve", "küste", "labor", "lachs", "lager", "lampe", "länge", "laune", "ledig", "legen",    "lehne", "lehre", "leine", "leise", "leser", "liebe", "likör", "lilie", "linie", "lippe", "liste",
    "liter", "lösen", "lügen", "luxus", "macht", "mähen", "malen", "maler", "marke", "markt", "masse",    "mäßig", "mathe", "mauer", "meist", "messe", "meter", "miete", "milch", "mitte", "möbel", "monat",    "motiv", "motor", "münze", "müsli", "mutig", "mutti", "mütze", "nackt", "nähen", "natur", "nebel",
    "nebst", "neffe", "nicht", "nomen", "notiz", "nstag", "nudel", "ochse", "olive", "opfer", "osten",    "ozean", "paket", "panne", "pappe", "paras", "pause", "peter", "pfand", "pfote", "pfund", "phase",    "pille", "pizza", "plaun", "polen", "ports", "profi", "pulli", "punkt", "puppe", "quote", "radio",
    "rasch", "rasen", "raten", "ratte", "rauch", "recht", "regal", "regel", "regen", "reich", "reihe",    "rente", "rhein", "roman", "rowdy", "runde", "russe", "salat", "sanft", "sauer", "sauna", "schaf",    "schal", "schoß", "schuh", "seide", "seife", "selbe", "serie", "sicht", "socke", "solch", "somit",
    "sooft", "spalt", "sport", "staat", "stahl", "stall", "stamm", "stand", "stark", "start", "statt",    "staub", "steak", "steif", "stein", "stern", "stirn", "stoff", "strom", "stufe", "stuhl", "stumm",    "sturm", "süden", "summe", "sünde", "suppe", "szene", "tabak", "tafel", "tango", "tante", "tasse",    "tätig", "tenor", "teuer", "theke", "thema", "titel", "toast", "toner", "tonne", "torte", "tragö",
    "trotz", "tulpe", "türke", "übung", "umbau", "union", "unter", "uralt", "urope", "venus", "video",    "villa", "virus", "vogel", "voran", "waage", "wachs", "warze", "weich", "welle", "wende", "wessi",    "wiese", "wieum", "wille", "witwe", "wolke", "wolle", "woran", "wunde", "wurst", "wüste", "zeile",    "zumal", "zunge", "zuvor", "zweck", "zwölf", "damit", "hallo", "igitt", "prima", "tself",
];
let selectedWord3 = words3[Math.floor(Math.random() * words3.length)];

const words4 = ["abends", "abfall", "abflug", "abitur", "ablauf", "absatz", "abteil", "achten", "aktion",    "albern", "alltag", "analog", "anfang", "angabe", "angeln", "angler", "anhand", "anlage", "anlass",    "anonym", "ansatz", "anteil", "antike", "antrag", "anzahl", "ärgern", "athlet", "ätzend", "aufbau",    "aufzug", "august", "auslän", "äußere", "äußern", "ausweg", "auszug", "backen", "bäcker", "balkon",
    "banane", "beamte", "becher", "bedarf", "beginn", "behint", "beisel", "beißen", "bellen", "benung",    "benzin", "bequem", "besser", "besuch", "betrag", "betrug", "beweis", "bewunn", "bilden", "billig",    "binden", "bisher", "bizeps", "blasen", "braten", "bremse", "brille", "brücke", "brunch", "bserve",    "bstahl", "buchen", "büfett", "bügeln", "bündel", "bürger", "butter", "campen", "campus", "chefin",
    "chemie", "clever", "cousin", "daheim", "danke", "danken", "dauern", "daumen", "decken", "defekt",    "detail", "deuten", "dialog", "diplom", "donner", "drehen", "dritte", "drohen", "dunkel", "dusche",    "ebenso", "effekt", "einzig", "eliver", "e-mail", "endlos", "epoche", "erfolg", "erforn", "essbar",
    "europa", "evote", "extrem", "fabrik", "fahrer", "faktor", "fallen", "fällen", "falten", "färben",    "farbig", "farmer", "fassen", "fehlen", "feiern", "ferien", "fertig", "fettig", "feucht", "fieber",    "fläche", "fliege", "flügel", "formel", "forung", "förung", "fragen", "freude", "frisch", "frisur",    "füllen", "furche", "fußweg", "futter", "gähnen", "gängig", "garage", "garobe", "garten", "gebiet",
    "gebühr", "geburt", "geduld", "gefahr", "gegend", "gegner", "gehalt", "geheim", "gehirn", "geiger",    "gelten", "gemein", "gemüse", "genial", "gepäck", "gering", "gesamt", "gesund", "gewalt", "gewinn",    "gießen", "gipfel", "gleich", "global", "golden", "grafik", "gratis", "grenze", "gruppe", "grüßen",    "gucken", "gulden", "gültig", "gürtel", "haarig", "hageln", "hälfte", "hammer", "handel", "hängen",
    "hassen", "haufen", "häufig", "heftig", "heilig", "heimat", "heirat", "heiter", "heizen", "henkel",    "herbst", "heulen", "hinauf", "hoffen", "hörbar", "hunger", "impfen", "import", "inhalt", "insekt",    "irisch", "irland", "island", "israel", "januar", "jemand", "jenige", "jezeit", "jobben", "jockey",    "joggen", "kaiser", "kamera", "kämmen", "kanada", "kaputt", "karton", "kasten", "käufer", "kaviar",    "kehren", "keller", "kessel", "kinlos", "kirche", "kissen", "klagen", "klären", "kleben", "klippe",
    "kneipe", "kochen", "kochin", "koffer", "kognak", "kondom", "können", "kosmos", "kosten", "kostüm",    "kotzen", "krampf", "kredit", "krippe", "kritik", "kuchen", "kultur", "kundin", "kürzen", "küssen",    "lagern", "landen", "langen", "latein", "lausig", "lauten", "leblos", "lecker", "leeren", "lehren",
    "lehrer", "leiden", "leihen", "leiten", "leiter", "letzte", "locker", "lockig", "löffel", "lösung",    "lumpen", "mangel", "mantel", "massiv", "maurer", "meiner", "melden", "merken", "messen", "messer",    "metall", "mexiko", "mieten", "mieter", "mittag", "mittel", "mitten", "moator", "modell", "mollig",
    "montag", "morgen", "museum", "nächst", "nachts", "nähern", "nation", "neblig", "nerven", "nervös",    "nichte", "nichts", "nicken", "niveau", "norden", "notruf", "nstags", "oberst", "objekt", "öffnen",    "online", "orange", "ordner", "ostern", "ostsee", "outfit", "packen", "panzer", "papier", "parfüm",    "parken", "partei", "passen", "person", "peseta", "pfanne", "pfeife", "physik", "planen", "platte",
    "pleite", "poster", "prägen", "praxis", "privat", "prüfen", "putzen", "quelle", "rabatt", "rächen",    "rakete", "rätsel", "räumen", "rechen", "regeln", "region", "regnen", "reifen", "reisen", "reißen",    "reiten", "reiter", "rekord", "relikt", "rennen", "rezept", "riesig", "risiko", "rostig", "rubrik",    "rüssel", "russin", "saftig", "saison", "salami", "salzig", "sandig", "sänger", "sauber", "saugen",    "schach", "scharf", "scheck", "schein", "schere", "schick", "schief", "schild", "schlag", "schlau",
    "schmal", "schnee", "schnei", "schock", "schopf", "schutz", "schwan", "schwül", "segeln", "seidig",    "selten", "senden", "senior", "senken", "sessel", "shorts", "silber", "singen", "simone", "sinken",    "sitzen", "sketch", "sofern", "soldat", "sommer", "sonnig", "soweit", "sowohl", "spalte", "sparen",    "spinat", "spitze", "spülen", "spüren", "stabil", "stärke", "stehen", "steuer", "stören", "strand",
    "streit", "streng", "stress", "strikt", "stumpf", "sturen", "südpol", "symbol", "system", "taktik",    "talent", "tanken", "tänzer", "tapete", "tapfer", "tatort", "teilen", "teller", "tennis", "termin",    "terror", "tippen", "tomate", "trauer", "treppe", "trikot", "truppe", "tunnel", "türkei", "türkin",    "turnen", "umfang", "umgang", "umland", "umsatz", "umwelt", "uneben", "unfall", "ungarn", "ungern",
    "urlaub", "urteil", "utopie", "veränn", "verben", "verein", "verlag", "vernen", "vernst", "vorbei",    "vorort", "vulkan", "wachen", "wählen", "wahren", "warnen", "wäsche", "wecken", "wecker", "weinen",    "wenden", "werfen", "westen", "wetten", "wetter", "widmen", "wiegen", "wiener", "wilich", "windig",    "winter", "winzig", "witwer", "witzig", "wohnen", "wolkig", "wunsch", "wurmig", "würzig", "wütend",    "zählen", "zauber", "zelten", "zensur", "zettel", "zeugin", "zimmer", "zinsen", "zögern", "zornig",
    "zucker", "zufall", "zugabe", "zugang", "zusatz", "arning", "coins", "herein", "schade", "servus",    "stimmt",
];
let selectedWord4 = words4[Math.floor(Math.random() * words4.length)];

const words5 = ["abfahrt", "abgeben", "abhaken", "abholen", "ablegen", "absehen", "absicht", "absolut",    "abstand", "abwasch", "adresse", "ähnlich", "alkohol", "analyse", "anbauen", "anfrage", "angeben",    "angebot", "angehen", "angriff", "anhören", "anklage", "ankunft", "anlegen", "ansehen", "ansicht",    "anstatt", "anthalb", "anzeige", "apparat", "appetit", "applaus", "armband", "artikel", "aufgabe",    "aufsatz", "auftrag", "ausfall", "ausflug", "ausgabe", "ausgang", "ausland", "ausrede", "aussage",
    "äußerst", "ausüben", "auswahl", "auswann", "ausweis", "automat", "bahnhof", "barcode", "bargeld",    "basteln", "baumlos", "baustil", "bedeckt", "bedroht", "beenden", "begehen", "begriff", "behörde",    "beinahe", "bekannt", "belegen", "belgien", "beliebt", "berater", "bereich", "bereits", "bereuen",
    "bericht", "berühmt", "besetzt", "besorgt", "bestand", "besteck", "betonen", "betrieb", "betteln",    "bewährt", "bewölkt", "bewusst", "bildung", "billard", "bislang", "blitzen", "botanik", "branche",    "brechen", "bremsen", "brennen", "brosche", "brüllen", "brünett", "buchung", "bürsten", "buschig",
    "bußgeld", "cheddar", "chronik", "college", "cousine", "damalig", "daneben", "dänisch", "danklos",    "darüber", "debatte", "deckung", "demnach", "deutsch", "dialekt", "digital", "donnern", "doppeln",    "doppelt", "dorthin", "drängen", "dreckig", "dreißig", "drinnen", "drittel", "dröhnen", "drucken",    "drücken", "drucker", "durstig", "duschen", "dutzend", "ehefrau", "ehemann", "ehepaar", "eingang",
    "einheit", "einhorn", "eintrag", "einwann", "einzeln", "eisbahn", "eiserne", "elefant", "elegant",    "element", "empfang", "energie", "england", "enkelin", "entlang", "entwurf", "ergeben", "erheben",    "erleben", "erobern", "erraten", "estland", "etliche", "experte", "fahrrad", "farblos", "fassade",
    "fassung", "februar", "festtag", "festung", "fischen", "flasche", "fleisch", "fleißig", "flicken",    "flieger", "fliehen", "fließen", "flirten", "fluchen", "folgend", "formlos", "franken", "freitag",    "fressen", "friseur", "führung", "fünfzig", "fußball", "füttern", "galaxie", "galerie", "gardine",
    "gärtner", "gasherd", "gasthof", "gebäude", "gedicht", "gehoben", "gehören", "geistig", "geladen",    "geliebt", "gemälde", "genauso", "genetik", "genügen", "geraten", "gerücht", "gestalt", "getränk",    "gewicht", "gewohnt", "giraffe", "gitarre", "gottlos", "gourmet", "grausam", "grenzen", "grieche",    "gründen", "grunzen", "günstig", "gurgeln", "haarlos", "haftung", "haltung", "hamster", "handeln",    "händler", "harmlos", "haustür", "heimweg", "heizung", "herzlos", "hierfür", "hilflos", "hinweis",
    "höflich", "hörsaal", "hügelig", "hungern", "hungrig", "illegal", "infolge", "italien", "jahraus",    "japaner", "jenigen", "jüdisch", "känguru", "kanzler", "kapelle", "kapitel", "kariert", "karotte",    "kellner", "klappen", "klärung", "klatsch", "klavier", "klebrig", "klingel", "klingen", "klopfen",    "klumpen", "knipsen", "koffein", "kollege", "kommend", "kommode", "komplex", "königin", "kontakt",    "kontext", "konzept", "konzern", "konzert", "kräftig", "kreativ", "künftig", "kutsche", "lächeln",
    "landung", "lauwarm", "lebhaft", "legende", "leisten", "leitung", "lenkrad", "letztes", "lexicon",    "lieblos", "liefern", "lispeln", "litauen", "löschen", "machbar", "mächtig", "magazin", "malerei",    "manager", "mancher", "manuell", "märchen", "matrose", "maximal", "medizin", "mehrere", "merkmal",
    "metzger", "million", "mittels", "modisch", "morgens", "moskito", "münchen", "murmeln", "musiker",    "nachbar", "nachher", "nämlich", "nebenan", "negativ", "neigung", "neujahr", "neulich", "niedrig",    "nielage", "niemand", "nieseln", "nochmal", "nordpol", "nordsee", "notfall", "nutzlos", "nutzung",    "ohnehin", "ohrring", "oktober", "ordnung", "östlich", "packung", "parkett", "partner", "passend",
    "patient", "pendler", "pension", "perfekt", "pfarrer", "pfeffer", "pfennig", "pflanze", "pflaume",    "pflegen", "pflicht", "pflügen", "pfosten", "pianist", "pistole", "planung", "plastik", "politik",    "popcorn", "populär", "porträt", "postamt", "präsens", "produkt", "projekt", "protzig", "provinz",    "prozent", "prüfung", "pudding", "quatsch", "radikal", "rasseln", "rathaus", "rauchen", "rechnen",
    "rechner", "referat", "reklame", "respekt", "rettung", "richter", "riechen", "rosarot", "rotkohl",    "rotwein", "rückzug", "sammeln", "samstag", "sandale", "sardine", "satteln", "scanner", "schädel",    "schaden", "schämen", "schauer", "scheibe", "schicht", "schlank", "schlips", "schloss", "schmerz",    "schmuck", "schnaps", "schrank", "schreck", "schrift", "schüler", "schwach", "schwarz", "schweiß",
    "schweiz", "seemann", "seitdem", "seither", "sekunde", "seltsam", "seminar", "sendung", "serbien",    "service", "sexuell", "shampoo", "sichern", "silbern", "sitzung", "softeis", "solcher", "sonntag",    "sonstig", "spalten", "spanien", "sparsam", "spiegel", "spieler", "spinnen", "sprache", "stadion",    "stammen", "starren", "starten", "stechen", "stecken", "stehlen", "steigen", "steuern", "stiefel",
    "stiften", "stimmen", "stinken", "stinkig", "stöhnen", "stoppel", "stoppen", "störung", "strecke",    "strumpf", "student", "studium", "stürzen", "südlich", "suspekt", "synonym", "tabelle", "täglich",    "taktlos", "tauchen", "tausend", "technik", "teppich", "theater", "theorie", "toaster", "tödlich",    "torwart", "tourist", "tragbar", "trainer", "trampen", "träumen", "traurig", "treffer", "trennen",
    "triumph", "trocken", "tropfen", "t-shirt", "typisch", "übersät", "uhrzeit", "ukraine", "umarmen",    "umfrage", "umgeben", "umgehen", "umsonst", "umstand", "unrecht", "ursache", "venedig", "verband",    "verkehr", "verlobt", "verlust", "versuch", "verwunt", "viertel", "vierzig", "violett", "vitamin",    "vokabel", "vorfahr", "vorfall", "vorgang", "vorhang", "vorlage", "vorname", "vorsatz", "vorteil",
    "vorwahl", "vorwurf", "wachsen", "während", "währung", "walkman", "warnung", "waschen", "website",    "wechsel", "wegfall", "weltall", "werbung", "wertlos", "weshalb", "wickeln", "wirksam", "wistand",    "wohnort", "wunkind", "wunvoll", "zahllos", "zahlung", "zahnlos", "zeichen", "zeitung", "zentral",
    "zentrum", "ziellos", "zigarre", "zittern", "züchten", "zugeben", "zugriff", "zuhause", "zuhören",    "zuletzt", "zwanzig", "zweifel", "zweimal", "zwiebel", "zwingen", "tschüss",
];
